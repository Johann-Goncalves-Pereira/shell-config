...
function gcdp() {
  ...
  echo "Going to $DEFAULT_BRANCH_NAME branch, and making a pull/fetch of your porject."
...
function git-purge() {
  ...
  echo "Purging all branchs, except $DEFAULT_BRANCH_NAME - from your local storage."
